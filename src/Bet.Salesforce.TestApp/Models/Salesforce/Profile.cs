...
namespace Bet.Salesforce.TestApp.Models.Salesforce
{
    ...
    public class Profile : SObject
    {
        ...
        /// <para>Name: PermissionsRecordVisibilityAPI.</para>
        /// <para>SF Type: boolean.</para>
        /// <para>Nillable: False.</para>
        /// </summary>
        [JsonProperty(PropertyName = "permissionsRecordVisibilityAPI")]
        [Updateable(true), Createable(false)]
        ...
        /// <summary>
        /// Modify Metadata (Beta if enabled without Modify All Data).
